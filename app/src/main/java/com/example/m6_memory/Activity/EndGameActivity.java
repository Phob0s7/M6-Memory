...
public class EndGameActivity extends AppCompatActivity {
    ...
    boolean chronometer;
    TextView tw_timeGame;
    TextView tw_score;
    TextView tw_best1;
    TextView tw_best2;
    TextView tw_best3;
    TextView pseudoBest1;
    ...
    private void getSharedPrefs() {
        ...
        editorTime = sharedPreferencesTime.edit();
    ...
    private void initializeScoreBoard() {
        ...
        tw_timeGame = findViewById(R.id.activity_game_easy_chronometer);
        tw_score = findViewById(R.id.activity_end_game_scores_txt);

        tw_best1 = findViewById(R.id.activity_end_game_scores1_txt);
        tw_best2 = findViewById(R.id.activity_end_game_scores2_txt);
        tw_best3 = findViewById(R.id.activity_end_game_scores3_txt);

        pseudoBest1 = findViewById(R.id.activity_end_game_nom1_txt);
